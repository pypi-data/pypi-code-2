...
class TestGroupsController(TestController):
    ...
    def test_create(self):
        ...
        self.assertEqual(_('/groups/@group1'), response.headers['location'])
    ...
    def test_update(self):
        ...
        response = self.app.post(url('groups', repo_id='repo1'),
                                 ...
                                 content_type='application/json')
        self.assertEqual(response.status, '201 Created')
        self.assertEqual(_('/groups/@group2'), response.headers['location'])
    ...
    def test_delete(self):
        ...
        response = self.app.post(url('groups', repo_id='repo1'),
                                 ...
                                 content_type='application/json')
        self.assertEqual(response.status, '201 Created')
        self.assertEqual(_('/groups/@group3'), response.headers['location'])
    ...
    def test_show(self):
        ...
        response = self.app.post(url('groups', repo_id='repo1'),
                                 ...
                                 content_type='application/json')
        self.assertEqual(response.status, '201 Created')
        self.assertEqual(_('/groups/@group4'), response.headers['location'])
