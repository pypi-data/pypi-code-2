...
class TestRulesController(TestController):
    ...
    def test_create(self):
        ...
        self.assertEqual(_('/rules/refex1,refex2;user1@test.com'), response.headers['location'])
    ...
    def test_update(self):
        ...
        response = self.app.post(url('rules', repo_id='repo1'),
                                 ...
                                 content_type='application/json')
        self.assertEqual(response.status, '201 Created')
        self.assertEqual(_('/rules/refex3;user2@test.com'), response.headers['location'])
    ...
    def test_delete(self):
        ...
        response = self.app.post(url('rules', repo_id='repo1'),
                                 ...
                                 content_type='application/json')
        self.assertEqual(response.status, '201 Created')
        self.assertEqual(_('/rules/refex4;user2@test.com'), response.headers['location'])
    ...
    def test_show(self):
        ...
        response = self.app.post(url('rules', repo_id='repo1'),
                                 ...
                                 content_type='application/json')
        self.assertEqual(response.status, '201 Created')
        self.assertEqual(_('/rules/refex5;user3@test.com'), response.headers['location'])
