...
class TestGroupsController(TestController):
    ...
    def test_update(self):
        ...
        response = self.app.post(url('groups', repo_id='repo1'),
                                 ...
                                 content_type='application/json')
        self.assertEqual(response.status, '201 Created')
        self.assertEqual(response.headers['location'].endswith(_('/groups/@group2')))
    ...
    def test_delete(self):
        ...
        response = self.app.post(url('groups', repo_id='repo1'),
                                 ...
                                 content_type='application/json')
        self.assertEqual(response.status, '201 Created')
        self.assertEqual(response.headers['location'].endswith(_('/groups/@group3')))
    ...
    def test_show(self):
        ...
        response = self.app.post(url('groups', repo_id='repo1'),
                                 ...
                                 content_type='application/json')
        self.assertEqual(response.status, '201 Created')
        self.assertEqual(response.headers['location'].endswith(_('/groups/@group4')))
